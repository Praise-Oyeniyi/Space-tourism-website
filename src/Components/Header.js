  ...
  return (
    <div>
        <div className="header-outer w-full flex justify-between text-gray-400 items-center py-5 relative transition-all">
            <div className="logo w-12 h-12 bg-gray-100 ml-[5%] rounded-full" onClick={()=>setActive(!active)}>
            ...
            <div className="h-[0.08em] w-[40%] bg-gray-600 relative left-14 sm:-left-[30%] sm:w-[50%]"></div>

            <div className={`nav w-3/6 bg-gray-900 justify-self-end bg-opacity-60 sm:w-full sm:absolute sm:top-0 sm:h-screen sm:z-10 sm:justify-self-auto delay-150 transition-all ${active? 'left-0' : 'left-full' }`}>
                    <div className="sm:flex sm:flex-col sm:w-3/6 sm:bg-gray-900 sm:h-full sm:relative sm:ml-[50%] justify-start items-center">
