...
const Header = () => {
  return (
    <div>
        <div className="header-outer w-full flex justify-between text-gray-400 items-center py-5">
            <div className="logo w-12 h-12 bg-gray-100 ml-[5%] rounded-full">
            ...
            <div className="nav w-3/6 bg-gray-900 justify-self-end bg-opacity-60 sm:flex sm:justify-center sm:mx-5 sm:w-20">
                ...
                <ul className='nav-link w-5/6 h-full flex justify-center items-center font-medium space-x-8 pl-5 text-sm sm:hidden'>
                    ...
                    <NavLink to='/technology'><li className='flex justify-between border-b-2 border-transparent py-5 hover:text-gray-100'><span className='text-gray-100 pr-1 font-semibold'>03</span>TECHNOLOGY</li></NavLink>
                </ul> 
            </div>
        </div>
    </div>
