...
const Home = () => {
  return (
    <div className='bg-desktop w-full h-screen flex flex-col justify-between overflow-x-hidden small:justify-start sm:space-y-10'>
        <Header/>
        <div className="h-full body-outer flex justify-around space-x-12 mx-[5%] my-[5%] md:my-16 items-center sm:flex-col sm:justify-center small:mx-[5%] sm:space-x-0 sm:space-y-16" >
